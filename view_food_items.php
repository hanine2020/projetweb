...
<?php
    ...
    $conn = mysqli_connect($db_server,$db_user_login, $db_user_pass, $db_name);
     ...
     $trie = isset($_POST['trie']) ? $_POST['trie'] : '';

     // la requete mysql
     $q = $conn->query(
     "SELECT name, description , price FROM food
      ORDER BY price ");

     // affichage du résultat
     while( $r = mysqli_fetch_array($q)){
     echo 'Résultat de la recherche: '.$r['name'].', '.$r['description'].' ,'.$r['description'].' <br />'
;
     }
?>
...
<?php
    ...
    $conn = mysqli_connect($db_server,$db_user_login, $db_user_pass, $db_name);
     ...
     // la requete mysql
     $q = $conn->query(
     "SELECT name, description FROM food
