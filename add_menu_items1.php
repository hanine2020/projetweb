...
$query = "INSERT INTO MENU(name,price,description,R_ID,images_path) VALUES('" . $name . "','" . $price . "','" . $description . "','" . $R_ID ."','" . $images_path . "')";
...
if (!$success){
  ...
  <!--Javacript for back to top button....................................................................-->
    ...
    <div class="jumbotron">
     <h1>Oops...!!! </h1>
     <p>Kindly enter your Restaurant details before adding Menu items.</p>
  ...
  <br>
	...
	echo "SUCCESS";
	header('Location: add_menu_items.php');
}
